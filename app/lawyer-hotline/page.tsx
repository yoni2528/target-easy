...
const Wave = ({
  ...
  <div className="relative -my-px" style={{ background: from }}>
    ...
    >
      <path
        d="M0,0 C360,50 720,50 1080,25 C1260,12 1380,0 1440,0 L1440,60 L0,60 Z"
        fill={to}
      />
    </svg>
  </div>
...
export default function LawyerHotlinePage() {
  return (
    <main className="min-h-screen insurance-theme overflow-x-hidden pt-14 md:pt-16">
      <LawyerNavbar />
      <LawyerHero />
      <ScenariosSection />
      ...
      <footer
        className="py-8 md:py-10 px-4 md:px-6 bg-white"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-3 md:gap-4">
              <a
                href="/terms"
                className="text-xs text-[#a0a0b0] hover:text-[var(--accent-blue)] transition-colors"
              >
                תנאי שימוש
              </a>
              <a
