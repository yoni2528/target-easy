...
const events = [
  ...
  {
    time: "T+30 דקות",
    title: "ליווי פיזי במחיר חבר (אופציה)",
    body: "אם המקרה מצדיק — נציג מהצוות מגיע פיזית. תוספת מסובסדת, באישור מראש, רק לחברי הקבוצה.",
    accent: "#1a6fcc",
  },
  {
    time: "T+יום",
    title: "אתה נושם",
    body: "התיק במעקב. אתה ממשיך בחיים, יודע שיש לך את הכי טוב בצד שלך.",
    accent: "#1a6fcc",
  },
];
