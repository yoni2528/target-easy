...
const faqs = [
  ...
  {
    q: "האם זה מחליף את הביטוח של מנורה?",
    a: "לא — אלו שני מוצרים נפרדים שמשלימים זה את זה. הביטוח מכסה אחריות צד ג׳ (כסף לנפגע, עו״ד אזרחי). המנוי המשפטי שלנו מטפל ספציפית ב-זמן החקירה הפלילית — הרגעים הקריטיים שבהם הביטוח עוד לא נכנס לתמונה. שילוב = הגנה מלאה.",
  },
  {
