...
const faqs = [
  {
    ...
    a: "ייעוץ טלפוני בלתי מוגבל מעו״ד פלילי 24/7, הוראות מיידיות במקרה חקירה, וייעוץ נמשך לכל התפתחות בתיק (שאלות המשך, מסמכים שאתה מקבל, התייעצויות חוזרות). הכל בטלפון, בלי הגבלת זמן.",
  },
  {
