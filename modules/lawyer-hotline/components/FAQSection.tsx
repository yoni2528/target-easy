...
const faqs = [
  {
    ...
    a: "ייעוץ טלפוני בלתי מוגבל מעו״ד פלילי 24/7 והוראות מיידיות במקרה חקירה. ליווי פיזי במקום או נציג לחקירה — לא כלולים במחיר החודשי, אבל זמינים במחיר מסובסד משמעותית לחברי הקבוצה (באישור מראש לפי הצורך).",
  },
  {
