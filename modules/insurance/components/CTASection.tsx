        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-right">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-4 bg-[var(--accent-blue)] text-white font-bold text-lg rounded-2xl hover:brightness-110 transition-all shadow-xl shadow-[var(--accent-blue)]/20 disabled:opacity-50"
            >
              {loading ? (
