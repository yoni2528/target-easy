...
const faqs = [
  {
    ...
    a: "אחריות צד ג׳ — נזקי גוף ורכוש שנגרמו לצד שלישי כתוצאה משימוש בנשק. כולל כיסוי לאירועי טרור, הגנה פלילית ומנהלית, וקו חם לעורך דין 24/7.",
  },
  {
    q: "למה לא להסתמך על הסנגוריה הציבורית?",
    a: "הסנגוריה הציבורית מספקת עורך דין שהוא עובד מדינה — לא בהכרח מומחה במקרי נשק. עם הביטוח מקבלים עורך דין מומחה שמכיר את התחום, זמין 24/7, ומלווה אותך לפני ואחרי העדות.",
  },
  {
    q: "כמה עולה כתב הגנה בלי ביטוח?",
    a: "רק להעמיד כתב הגנה עולה 65,000–100,000 ש״ח — עוד לפני שמגיעים לאולם בית המשפט. עם הביטוח, הכל מכוסה עד 400,000 ש״ח.",
  },
  {
    q: "מה גובה הכיסוי?",
    a: "עד 3,000,000 ש״ח לנזקי גוף ורכוש לצד שלישי, ועד 400,000 ש״ח להגנה פלילית ומנהלית — כולל עורך דין, ייצוג בבית משפט וערעורים.",
  },
  {
    q: "מה קורה במקרה של גניבת נשק?",
    a: "הביטוח מכסה את ההגנה המשפטית במקרה שנפתח תיק פלילי, וגם מחזיר את עלות האקדח שנגנב.",
  },
  {
    q: "האם הביטוח מכסה אירועי טרור?",
    a: "כן. זהו כיסוי ייחודי — הביטוח מכסה שימוש בנשק במהלך אירוע טרור, כולל ההגנה המשפטית שנדרשת לאחר מכן.",
  },
  {
    q: "מה לא מכוסה?",
    a: "שימוש בנשק לצורכי עבירה פלילית, שימוש תחת השפעת אלכוהול או סמים, שימוש ברישיון שפג תוקפו, או שימוש במסגרת עבודה כמאבטח.",
  },
  {
    q: "איך מצטרפים?",
    a: "ב-3 שלבים פשוטים: משאירים פרטים, מקבלים שיחה מנציג, ומתחילים להיות מוגנים. בלי ניירת ובלי בירוקרטיה.",
  },
];
