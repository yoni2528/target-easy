...
const scenarios = [
  ...
  { title: "הסנגוריה הציבורית", brief: "כשלא רוצים לסמוך על עו״ד של המדינה",
  ...
  { title: "פגיעה בצד ג׳", brief: "פגיעה באדם בזמן שימוש לגיטימי בנשק",
    full: "ירי במטווח, אימון או הגנה עצמית שפוגע בעובר אורח. הנפגע תובע פיצויים. עלות ייצוג: ₪40,000+. פיצויים אפשריים: עד ₪2,000,000." },
];
