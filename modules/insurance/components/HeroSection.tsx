  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-[var(--accent-blue)]/5 via-transparent to-transparent" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-[var(--accent-blue)]/3 blur-[120px]" />
        <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-[var(--accent-green)]/3 blur-[80px]" />
      </div>

      {/* Animated rings */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[600px] h-[600px] rounded-full border border-[var(--accent-blue)]/5 animate-[pulse_4s_ease-in-out_infinite]" />
        <div className="absolute w-[400px] h-[400px] rounded-full border border-[var(--accent-blue)]/8 animate-[pulse_4s_ease-in-out_infinite_0.5s]" />
        <div className="absolute w-[200px] h-[200px] rounded-full border border-[var(--accent-blue)]/12 animate-[pulse_4s_ease-in-out_infinite_1s]" />
      </div>

      {/* Shield icon */}
      <div className="relative mb-6 animate-[fadeIn_1s_ease-out]">
        <Shield className="w-16 h-16 text-[var(--accent-blue)]" strokeWidth={1} />
        <div className="absolute inset-0 w-16 h-16 rounded-full bg-[var(--accent-blue)]/10 blur-xl" />
      </div>
      ...
      {/* Subtitle */}
      <p className="text-xl md:text-2xl text-[var(--accent-blue)] font-medium mb-4 animate-[fadeInUp_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
        למחזיקי נשק ברישיון
      </p>
      ...
      <div className="flex gap-4 animate-[fadeInUp_0.8s_ease-out_0.6s] opacity-0 [animation-fill-mode:forwards]">
        <a
          href="#modules"
          className="px-8 py-3 bg-[var(--accent-blue)] text-[var(--bg-primary)] font-bold rounded-xl hover:brightness-110 transition-all shadow-lg shadow-[var(--accent-blue)]/20"
        >
          מה מכוסה?
        </a>
        <a
