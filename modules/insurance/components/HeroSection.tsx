  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-[var(--accent-blue)]/5 blur-[80px]" />
      </div>
      ...
      <div className="flex gap-4 animate-[fadeInUp_0.8s_ease-out_0.6s] opacity-0 [animation-fill-mode:forwards]">
        <a
          href="#modules"
          className="px-8 py-3 bg-[var(--accent-blue)] text-white font-bold rounded-xl hover:brightness-110 transition-all shadow-lg shadow-[var(--accent-blue)]/20"
        >
          מה מכוסה?
        </a>
        <a
